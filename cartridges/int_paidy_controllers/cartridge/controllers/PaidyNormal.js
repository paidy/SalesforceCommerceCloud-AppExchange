 ...
 *
 * @module controllersPAIDY_NORMAL
 */
...
function getPaidyConfig() {
    ...
    '/cartridge/scripts/paidy/normal/authorize').getPaidyConfig(
...
/**
 * Paidy (normal) Process to finalize an order with payment.
 * @returns {Object} Returns the defined cartridge COPlaceOrder-Submit
 */
function placeOrder() {
    var paidyCartridge = require('*/package.json').paidyCartridge;
    var placeOrderResult = require(paidyCartridge +
    '/cartridge/scripts/paidy/normal/authorize').validationPlaceOrder(
 ...
 *
 * @see {@link module:controllers/PAIDY_NORMALl~getPaidyConfig}
 */
 ...
 * failure.
 *
 * @see {@link module:controllers/PAIDY_NORMAL~failOrder}
 */
exports.FailOrder = guard.ensure(['https', 'get', 'csrf'], failOrder);
/**
 * Paidy (normal) Process to finalize an order with payment.
 *
 * @see {@link module:controllers/PAIDY_NORMAL~placeOrder}
 */
