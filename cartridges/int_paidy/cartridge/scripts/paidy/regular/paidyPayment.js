...
/**
*
* This script attempts to make a payment by using Paidy Regular method.
*
*/
...
/**
 * create a Paidy regular payment
 * @param {Object} order - The order object passed to paidyPay
...
function paidyPay(pdict, paidyId) {
    ...
    try {
        // the nomal payment API path includes "paidyPaymentId" at the end
        ...
        // nomal payments should send a "GET" request. And regular payments should send a "POST" request.
