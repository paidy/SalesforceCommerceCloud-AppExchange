...
server.get('GetPaidyConfig', server.middleware.https, function (req, res, next) {
    ...
    var responseJson = require('*/cartridge/scripts/paidy/normal/authorize').getPaidyConfig(PaymentType);
...
server.get(
    ...
    function (req, res, next) {
        ...
        var validationPlaceOrderResult = require('*/cartridge/scripts/paidy/normal/authorize').validationPlaceOrder(
