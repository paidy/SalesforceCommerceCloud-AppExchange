...
|Cartridge|version|
|-|-|
|int_paidy / int_paidy_controllers |21.1.0|
|int_paidy_sfra|21.1.0|

## Integration

|Cartridge|Integration|
|-|-|
|int_paidy / int_paidy_controllers |./documentation/Paidy_Integration_Guide_v21.1.0_en.pdf|
|int_paidy_sfra|./documentation/Paidy_sfra_Integration_Guide_v21.1.0_en.pdf|
