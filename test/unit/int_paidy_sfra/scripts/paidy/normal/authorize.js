...
describe('SFRA: Authorize for PAIDY_NORMAL', function () {
    var Authorize = proxyquire('../../../../../../cartridges/int_paidy_sfra/cartridge/scripts/paidy/normal/authorize', {
        ...
        '*/cartridge/scripts/paidy/regular/callService': {
    ...
    it('should return setup values where "payment_method" is "PAIDY_NORMAL"', function () {
        var expectedValue = {
            api_key: '',
            logo_url: '',
            metadata: null,
            closed: 'Replace this with a callback func. (callbackData) => {...}',
            payment_method: 'PAIDY_NORMAL',
        ...
        assert.equal(JSON.stringify(Authorize.getPaidyConfig('PAIDY_NORMAL')), JSON.stringify(expectedValue));
    });
