...
describe('SFRA: Paidy payment utilities', function () {
    var PaidyUtils = proxyquire('../../../../../cartridges/int_paidy_sfra/cartridge/scripts/paidy/paidyUtils', {
        'dw/util/StringUtils': {
