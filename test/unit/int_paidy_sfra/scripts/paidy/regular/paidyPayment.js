...
describe('SFRA: Confirm payment for PAIDY_REGULAR', function () {
    var PaidyPayment = proxyquire('../../../../../../cartridges/int_paidy_sfra/cartridge/scripts/paidy/regular/paidyPayment', {
    ...
    it('should return the successful result of the Paidy API', function () {
        var currentOrder = order.baseOrderMock();
        var paidyToken = '';
        var expectedValue = {
            code: 'OK',
            details: {
        ...
        assert.equal(JSON.stringify(PaidyPayment.paidyPay(currentOrder, paidyToken)), JSON.stringify(expectedValue));
    });
});
