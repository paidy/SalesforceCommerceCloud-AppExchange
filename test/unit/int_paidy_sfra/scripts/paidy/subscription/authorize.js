...
describe('SFRA: Authorize for PAIDY_SUBSCRIPTION', function () {
    var Authorize = proxyquire('../../../../../../cartridges/int_paidy_sfra/cartridge/scripts/paidy/subscription/authorize', {
        server: {
            forms: {
                getForm: function () {
                    return {
