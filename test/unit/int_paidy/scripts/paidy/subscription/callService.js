...
describe('SiteGenesis: Try to call service for PAIDY_SUBSCRIPTION', function () {
    var serviceRequest = require('../../../../../mocks/serviceRequest');
    var serviceResponse = require('../../../../../mocks/serviceResponse');

    var CallService = proxyquire('../../../../../../cartridges/int_paidy/cartridge/scripts/paidy/subscription/callService', {
