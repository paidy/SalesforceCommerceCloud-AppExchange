...
describe('SiteGenesis: Authorize for PAIDY_SUBSCRIPTION', function () {
    var Authorize = proxyquire('../../../../../../cartridges/int_paidy/cartridge/scripts/paidy/subscription/authorize', {
        'dw/system/Logger': {
            debug: function (text) {
                return text;
            },
